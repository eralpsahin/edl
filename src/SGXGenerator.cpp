...
static llvm::cl::opt<std::string> defined_t(
    "defined_t", llvm::cl::desc("Specify trusted side defined functions file path"),
    llvm::cl::value_desc("defined_t"));

static llvm::cl::opt<std::string> ecalls(
    "ecalls", llvm::cl::desc("Specify the ECALL functions wrapper code path"), // generated by edl pass
...
void pdg::SGXGenerator::generateAppFile(unsigned eidLine, unsigned initLine) {
  ...
  while (getline(appFile, line)) {
    ...
    if (currLine == ecallVec[ecallIdx].line) {
